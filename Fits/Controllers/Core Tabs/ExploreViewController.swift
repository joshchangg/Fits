...
//        let model = models[indexPath.row]
        let user = User(username: "@josh", name: (first: "", last: ""), profilePhoto: URL(string: "https://www.google.com")!, bio: "", birthDate: Date(), gender: .male, counts: UserCount(followers: 1, following: 1, posts: 1), joinDate: Date())
